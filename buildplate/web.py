...
from buildplate.folderstructure import list_all, provision
from buildplate.design import MESH_FILE_EXTENSIONS
...
def create():
    ...
    _stream, destination = tempfile.mkstemp(prefix=filename, suffix = f".{extension.lower()}")
