"""Helpers for finding or creating the central library directory.

   The central library directory is the location in which all design files
...
def bootstrap():
    """ Create the library directory if it does not already exist"""
